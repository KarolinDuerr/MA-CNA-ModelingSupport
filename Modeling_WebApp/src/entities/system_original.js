...
class System { // TODO use ID's as keys instead of name?
    ...
    addDataAggregateEntity(dataAggregateEntityToAdd) {
        ...
        this.#dataAggregateEntities.set(dataAggregateEntityToAdd.name, dataAggregateEntityToAdd);
    }
    ...
    addBackingDataEntity(backingDataEntityToAdd) {
        ...
        this.#backingDataEntities.set(backingDataEntityToAdd.name, backingDataEntityToAdd);
    }
