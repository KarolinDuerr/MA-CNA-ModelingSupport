...
1. [Language Characteristics](LanguageCharacteristics.md)

2. [Cloud Modeling Capabilities](CloudModelingCapabilities.md)

3. [Representation of Proposed Entities](RepresentationOfProposedEntities.md)

4. [Architectural Evaluations](ArchitecturalEvaluations.md)

5. [Tooling Support](ToolingSupport.md)
